...
class Step3 extends React.Component<Step3Props, Step3State>
{
    ...
    async sendInstructions()
    {
        ...
        const response = await fetch('http://192.168.50.1:5000/uploadInstructions', {method: 'POST', body: JSON.stringify({nav: mappingArea}), headers: {'Content-Type': 'application/json; charset=UTF-8'}});
